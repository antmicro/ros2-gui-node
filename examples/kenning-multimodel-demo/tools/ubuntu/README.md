...
Directory contains tools prepared for running Kenning Multimodel Demo for Ubuntu and other Linux platforms running **systemd**.
It consists of:
...
To install the demo on **NVIDIA Jetson** platform, type:
``` bash
./install.sh jetson
```
